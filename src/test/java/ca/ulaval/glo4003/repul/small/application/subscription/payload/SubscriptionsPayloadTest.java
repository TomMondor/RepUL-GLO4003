...
public class SubscriptionsPayloadTest {
    ...
    private static final LocationPayload LOCATION_PAYLOAD =
    ...
    public void whenUsingFrom_shouldReturnCorrectSubscriptionsPayload() {
        SubscriptionPayload subscriptionPayload =
            new SubscriptionPayload(SUBSCRIPTION_ID, ORDERS_PAYLOAD, SUBSCRIPTION_FREQUENCY, LOCATION_PAYLOAD, SUBSCRIPTION_START_DATE,
                SUBSCRIPTION_LUNCHBOX_TYPE);
        SubscriptionsPayload expectedSubscriptionsPayload = new SubscriptionsPayload(List.of(subscriptionPayload));
