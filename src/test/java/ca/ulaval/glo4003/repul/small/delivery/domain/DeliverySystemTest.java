...
public class DeliverySystemTest {
    ...
    public void givenValidValue_whenCreateMealKit_shouldCreateMealKit() {
        DeliverySystem deliverySystem =
            new DeliverySystemFixture().withLocationsCatalog(new LocationsCatalogFixture().addDeliveryLocation(A_DELIVERY_LOCATION).build()).build();

        deliverySystem.createMealKit(A_DELIVERY_LOCATION_ID, A_MEALKIT_ID);

        assertDoesNotThrow(() -> deliverySystem.getMealKit(A_MEALKIT_ID));
    }
