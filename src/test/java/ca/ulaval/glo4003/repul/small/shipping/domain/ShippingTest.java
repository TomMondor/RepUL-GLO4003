...
public class ShippingTest {
    ...
    public void whenPickupCargo_shouldReturnListOfMealKitShippingInfo() {
        ...
        List<MealKitShippingInfo> mealKitShippingInfos = shipping.pickupCargo(A_SHIPPER_ID, ticketId);
    ...
    public void whenConfirmShipping_shouldSetShippingStatusToDelivered() {
        ...
        shipping.confirmShipping(A_SHIPPER_ID, ticketId, A_MEALKIT_ID);
    ...
    public void givenInvalidShippingId_whenConfirmShipping_shouldThrowInvalidShippingIdException() {
        ...
        assertThrows(InvalidShippingIdException.class, () -> shipping.confirmShipping(A_SHIPPER_ID, A_INVALID_SHIPPING_TICKET_ID, A_MEALKIT_ID));
    }
    ...
    public void givenInvalidMealKitId_whenConfirmShipping_shouldThrowInvalidMealKitIdException() {
        ...
        assertThrows(InvalidMealKitIdException.class, () -> shipping.confirmShipping(A_SHIPPER_ID, ticketId, ANOTHER_MEALKIT_ID));
    }
    ...
    public void whenUnconfirmShipping_shouldSetShippingStatusToInDelivery() {
        ...
        shipping.unconfirmShipping(A_SHIPPER_ID, ticketId, A_MEALKIT_ID);
    ...
    public void givenInvalidShippingId_whenUnconfirmShipping_shouldThrowInvalidShippingIdException() {
        ...
        assertThrows(InvalidShippingIdException.class, () -> shipping.unconfirmShipping(A_SHIPPER_ID, A_INVALID_SHIPPING_TICKET_ID, A_MEALKIT_ID));
    }
    ...
    public void givenInvalidMealKitId_whenUnconfirmShipping_shouldThrowInvalidMealKitIdException() {
        ...
        assertThrows(InvalidMealKitIdException.class, () -> shipping.unconfirmShipping(A_SHIPPER_ID, ticketId, ANOTHER_MEALKIT_ID));
    }
