...
public class PaymentServiceTest {
    ...
    public void whenHandlingMealKitConfirmedEvent_shouldAcceptAndNotThrow() {
        MealKitConfirmedEvent mealKitConfirmedEvent = new MealKitConfirmedEvent(A_UNIQUE_IDENTIFIER, A_UNIQUE_IDENTIFIER, A_UNIQUE_IDENTIFIER,
            A_MEALKIT_TYPE, A_DELIVERY_LOCATION_ID, A_DELIVERY_DATE);
