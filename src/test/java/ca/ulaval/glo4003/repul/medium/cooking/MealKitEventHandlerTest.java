...
public class MealKitEventHandlerTest {
    ...
    private static final RecipesCatalog
        A_RECIPES_CATALOG = new RecipesCatalog(Map.of(A_MEAL_KIT_TYPE, new ArrayList<>()));
    ...
    public void whenHandlingPickUpCargoEvent_shouldRemoveMealKitToKitchen() {
        PickedUpCargoEvent pickedUpCargoEvent =
            new PickedUpCargoEvent(List.of(DEFAULT_MEAL_KIT_ID));
