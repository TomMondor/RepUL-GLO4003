...
public class NotificationServiceWithLogManualTest {
    ...
    private static final Optional<LockerId>
        AN_OPTIONAL_LOCKER_ID = Optional.of(new LockerId("A_LOCKER_ID", 1));
    ...
    private static final List<MealKitDto> MEAL_KIT_DTOS =
        List.of(new MealKitDto(A_DELIVERY_LOCATION_ID, AN_OPTIONAL_LOCKER_ID, A_MEAL_KIT_ID),
